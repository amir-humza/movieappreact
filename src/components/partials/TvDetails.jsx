    ...
    >
      ...
      <div className="w-full flex-col sm:flex-row flex ">
        ...
        <div className="content sm:ml-10 text-zinc-100">
          ...
          <h3 className="text-xl font-semibold mt-3">tv Translated</h3>
      ...
      <h1 className="mt-5 text-2xl font-semibold text-white">Seasons</h1>
        ...
        {info.detail.seasons.length > 0 ? info.detail.seasons.map((s, i) => (
          <div key={i} className="w-[15vh] mr-[7%]">
            <img
              ...
              alt=""
            />
            <h1 className="text-zinc-200 mt-2 text-lg leading-tight font-semibold">
              {s.name}
            </h1>
          </div>
